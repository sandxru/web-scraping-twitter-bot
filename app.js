...
async function scrapeBuy(url) {
    ...
    await page.goto(url);
    await page.waitForXPath('//*[@id="__APP"]/div[2]/main/div[1]/div[4]/div/div[2]/div[4]/div[1]/div[2]/div/div/div[1]')
    await page.waitForSelector('.css-1m1f8hn')
    const [el] = await page.$x('//*[@id="__APP"]/div[2]/main/div[1]/div[4]/div/div[2]/div[4]/div[1]/div[2]/div/div/div[1]');
